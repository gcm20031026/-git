...
QT_MOC_LITERAL(1, 11, 17), // "faceDetectChanged"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 7) // "enabled"

    },
    "InfoWidget\0faceDetectChanged\0\0enabled"
};
...
void InfoWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->faceDetectChanged((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (InfoWidget::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&InfoWidget::faceDetectChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void InfoWidget::faceDetectChanged(bool _t1)
{
